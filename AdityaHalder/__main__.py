...
async def initiate_bot():
    ...
    console.print(
        "[bold green] 🥀 Devil Kingbot Started ✨\n"
    )
    try:
        await robot.send_message(
            LOG_GROUP_ID,
            "<b> 🥀 Devil KingBot is Here ✨</b>",
        )
    ...
    if STRING_SESSION != "None":
        ...
        console.print(f"└[red] ✅ Devil KingBot Boot Complete 💯 ...")
        await idle()
        console.print(f"\n[red] Userbot Stopped")
...
ᴍʏ ɴᴀᴍᴇ ɪs {BOT_NAME}.
I Aᴍ DEVIL, Aɴ Aᴅᴠᴀɴᴄᴇᴅ KingBᴏᴛ Wɪᴛʜ Sᴏᴍᴇ Usᴇғᴜʟ Fᴇᴀᴛᴜʀᴇs.**"""


@robot.on_message(command(["start"]) & filters.private)
async def start(_, message):
    await message.reply_photo(
        photo=f"https://graph.org/file/ac6b9ad447404863e32bd.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
💥 Hᴇʟʟᴏ, I Aᴍ D𝙴𝚅𝙸𝙻 » Aɴ Aᴅᴠᴀɴᴄᴇᴅ
Pʀᴇᴍɪᴜᴍ Tᴇʟᴇɢʀᴀᴍ K𝙸𝙽𝙶 Bᴏᴛ.

┏━━━━━━━━━━━━━━━━━━━┓
┣★ Oᴡɴᴇʀ'xD› : [D𝙴𝚅𝙸𝙻 Hᴀʟᴅᴇʀ](https://t.me/Devilxdy)
┣★ Uᴘᴅᴀᴛᴇs ›› : [D𝙴𝚅𝙸𝙻 Sᴇʀᴠᴇʀ](https://t.me/Classics0012)
┣★ Sᴜᴘᴘᴏʀᴛ » : [D𝙴𝚅𝙸𝙻 Dɪsᴄᴜs](https://t.me/Classics0012)
┗━━━━━━━━━━━━━━━━━━━┛
            ...
            [
                [
                    InlineKeyboardButton(
                        "💥 Dᴇᴘʟᴏʏ D𝙴𝚅𝙸𝙻 K𝙸𝙽𝙶Bᴏᴛ ✨", url=f"https://t.me/Classics0012")
                ]
...
D𝙴𝚅𝙸𝙻 K𝙸𝙽𝙶Bᴏᴛ Vᴇʀ : `2.0` 🔥...

💞 Jᴜsᴛ Cʟɪᴄᴋ Oɴ Bᴇʟᴏᴡ Iɴʟɪɴᴇ
Tᴏ Gᴇᴛ D𝙴𝚅𝙸𝙻 Cᴏᴍᴍᴀɴᴅs ✨...**
""".format(
            first_name=name
        ),
        keyboard,
